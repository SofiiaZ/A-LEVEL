...
+ [селекторами псевдоклассов и псевдоэлементов](#psevd)
+ [атрибутивными](#atr)
+ [дочерними](#child)
+ [родственными](#sister)
...
### :arrow_forward: <a name="child">Дочерний селектор</a>
...
### :arrow_forward: <a name="sister">Сестринский селектор</a>
...
### :arrow_forward: <a name="atr">Селектор атрибута</a>
...
### :arrow_forward: <a name="psevd">Селектор псевдокласса</a>
...
### :arrow_forward: Селектор псевдокласса
...
### :arrow_forward: Селектор псевдоэлемента
